          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                Review pending campaigns, payout readiness, risk context, and decision history.
              </p>
            </div>

            <Link
              href="/dashboard/owner/campaign-reviews"
              className="inline-flex w-fit shrink-0 items-center justify-center rounded-xl bg-amber-500 px-4 py-2.5 text-sm font-bold text-slate-950 transition hover:bg-amber-600"
            >
              Open review queue
