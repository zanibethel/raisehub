...
import OwnerAttentionCenter from './sections/owner-attention-center'
...
export default function OwnerDashboardContent({
  ...
  return (
    <div className="mt-8 min-w-0 space-y-6">
      ...
      <details id="owner-analytics" className="group rounded-3xl border border-slate-200 bg-white shadow-sm">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 p-5 sm:p-6">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.14em] text-blue-700">Platform snapshot</p>
            <h2 className="mt-1 text-xl font-bold text-slate-950">Live totals and performance signals</h2>
            <p className="mt-1 text-sm leading-6 text-slate-600">Expand when you need the full analytics snapshot.</p>
          </div>
