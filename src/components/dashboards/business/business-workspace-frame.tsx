...
function RewardsIcon() {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5"><path d="M8 3h8l-1 4h-6L8 3Z" /><path d="M6 7h12v3a6 6 0 0 1-12 0V7Z" /><path d="M12 16v5" /><path d="M8 21h8" /><path d="M6 9H4a2 2 0 0 0 2 3" /><path d="M18 9h2a2 2 0 0 1-2 3" /></svg>
}
