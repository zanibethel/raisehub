    ...
    <div className="mt-8 space-y-8">
      ...
      <details className="group rounded-2xl border border-blue-100 bg-white/90 shadow-xl backdrop-blur">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
          <div>
            <p className="text-lg font-bold text-gray-900">Performance and analytics</p>
            <p className="mt-1 text-sm text-gray-600">View campaign totals, revenue reporting, and top seller activity.</p>
          </div>
          <span className="shrink-0 rounded-full bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-700 group-open:hidden">View</span>
