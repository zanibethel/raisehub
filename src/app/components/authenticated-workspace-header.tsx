...
export default function AuthenticatedWorkspaceHeader({
  ...
  const drawer = drawerOpen ? (
    <div className="fixed inset-0 z-[300] h-[100dvh] w-screen">
      <button
        type="button"
      ...
      <section className="absolute inset-x-0 bottom-0 flex max-h-[min(78dvh,42rem)] flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:inset-y-0 sm:left-auto sm:right-0 sm:max-h-none sm:w-96 sm:rounded-none">
