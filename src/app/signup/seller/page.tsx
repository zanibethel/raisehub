...
export default function SellerSignupPage() {
  ...
  async function handleSignup(event: React.FormEvent<HTMLFormElement>) {
    ...
    const destination = '/seller/onboarding'
    ...
    setMessage('Account created. Check your email to confirm your account, then continue setting up your seller profile.')
    setLoading(false)
  }
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <section className="rounded-3xl border border-blue-100 bg-white/95 p-7 shadow-xl sm:p-10">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">Create one seller profile, join an organization, choose your name from its roster, and keep the same seller identity across future campaigns.</p>

            <div className="mt-8 space-y-4">
              {[
                ['1', 'Create your seller profile', 'Use your own name and account.'],
                ['2', 'Join an organization', 'Accept an invitation or organization join link.'],
          ...
          <aside className="h-fit rounded-3xl border border-blue-100 bg-white p-7 shadow-xl sm:p-8">
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">After confirming your email, RaiseHub will create your reusable seller profile and guide you to your organization roster.</p>
            ...
            <div className="mt-6 border-t border-gray-200 pt-5 text-sm text-gray-600">
              Already have an account? <Link href="/login?next=/seller/onboarding" className="font-semibold text-blue-700 hover:underline">Log in here</Link>
            </div>
          </aside>
        </div>
      </div>
