...
export const LAKEVIEW_OFFERS = [
  { key: 'coffee-bogo', businessKey: 'mapleCoffee', title: 'Buy One Drink, Get One 50% Off', description: 'Enjoy a second handcrafted drink for half price.', discount: '50% off second drink', usageRule: 'one-time', startOffsetDays: -30, endOffsetDays: null, active: true },
  { key: 'coffee-pastry', businessKey: 'mapleCoffee', title: 'Free Pastry with Two Large Drinks', description: 'Choose one bakery pastry with the purchase of two large drinks.', discount: 'Free pastry', usageRule: 'one-time', startOffsetDays: -10, endOffsetDays: null, active: true },
  { key: 'salon-upgrade', businessKey: 'willowSalon', title: 'Complimentary Deep Conditioning Upgrade', description: 'Add a deep conditioning treatment to any paid haircut service.', discount: 'Free service upgrade', usageRule: 'one-time', startOffsetDays: -15, endOffsetDays: null, active: true },
  { key: 'jump-family', businessKey: 'jumpHouse', title: '$8 Off a Family Jump Session', description: 'Save on one family open-jump session for up to four guests.', discount: '$8 off', usageRule: 'one-time', startOffsetDays: -20, endOffsetDays: null, active: true },
  { key: 'auto-oil', businessKey: 'autoCare', title: 'Free Tire Rotation with Oil Change', description: 'Receive a standard tire rotation with a qualifying oil change.', discount: 'Free tire rotation', usageRule: 'one-time', startOffsetDays: -7, endOffsetDays: null, active: true },
  { key: 'fitness-class', businessKey: 'fitness', title: 'Two-for-One Family Fitness Class', description: 'Bring a family member free to one eligible group class.', discount: 'Buy one, get one free', usageRule: 'one-time', startOffsetDays: -35, endOffsetDays: null, active: true },
  ...
  { key: 'quantum-consult', businessKey: 'quantumRehab', title: 'Complimentary Mobility Technology Consultation', description: `Discuss mobility goals, power-chair features, seating, and control options. ${EXPO_DEMO_DISCLAIMER}`, discount: 'Free consultation', usageRule: 'one-time', startOffsetDays: -2, endOffsetDays: null, active: true },
  { key: 'sunrise-config', businessKey: 'sunriseMedical', title: 'Free Wheelchair Configuration Review', description: `Review fit, chair configuration, seating, and potential efficiency improvements. ${EXPO_DEMO_DISCLAIMER}`, discount: 'Free configuration review', usageRule: 'one-time', startOffsetDays: -2, endOffsetDays: null, active: true },
  { key: 'mobilityworks-assessment', businessKey: 'mobilityWorks', title: 'Free Accessible Vehicle Needs Assessment', description: `Explore vehicle access, driving adaptations, transfers, and mobility-equipment transport needs. ${EXPO_DEMO_DISCLAIMER}`, discount: 'Free assessment', usageRule: 'one-time', startOffsetDays: -2, endOffsetDays: null, active: true },
  { key: 'surehands-home', businessKey: 'sureHands', title: 'Free Home Transfer Consultation', description: `Discuss lift, transfer, bathroom, and home-accessibility needs with no purchase required. ${EXPO_DEMO_DISCLAIMER}`, discount: 'Free consultation', usageRule: 'one-time', startOffsetDays: -2, endOffsetDays: null, active: true },
] as const
